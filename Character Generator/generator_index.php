...
<button id="import-csv">Daten in die Datenbank importieren</button>
<script>
    document.getElementById('import-csv').addEventListener('click', () => {
        fetch('upload_csv_to_db.php', { method: 'POST' })
            .then(response => response.json())
            .then(data => console.log(data.message))
            .catch(error => console.error('Fehler beim Importieren der CSV:', error));
    });
</script>
